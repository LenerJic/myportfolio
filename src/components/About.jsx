    ...
    <section id="about" className="section">
      <div className="container mx-auto">
        <div className="flex flex-col gap-y-5 lg:flex-row lg:items-center lg:gap-x-20 lg:gap-y-0 h-screen">
          <div className="h-64 lg:h-1/2 px-6 lg:w-1/2 md:mt-6 lg:px-4">
          ...
          <div className="flex-1 text-center lg:text-left p-4">
            ...
            <p className="text-justify md:text-2xl/9 lg:text-base 2xl:text-lg leading-6">
              Soy apasionado a la programación con un gran interés en crear aplicaciones web con experiencias de usuario modernas, interactivas 
